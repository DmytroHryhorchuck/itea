  ...
  */
  ...
  // execution.onclick = CounterAdd( false );
  ...
  */
  ...
  eventObj.onclick = function( event ){
    console.log( 'event', event, event.target, event.target.dataset.attr, this );
  };

  // document.onclick = function( event ){
  //   if( event.altKey === true ){
  //     console.log('click on cordinate:', event.clientX, event.clientY, event.target, this);
  //   }
  // };
