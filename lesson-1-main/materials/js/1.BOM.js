...
/*
	Обратите внимание что объект screen показывает именно размер экрана,
	...
	window.innerWidth (поддержка IE8+) - показывает всю физическую ширину окна в рх
*/
...
/*
	Главная суть этой демки, что бы вы начали понимать, как устроен браузер
	и как привычные и понятные нам действия отображаются в глобальном объекте.
	По сути любое изменение или событие которое происходит в окне браузера,
